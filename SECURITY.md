...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/Cliometrics.jl/security/advisories/new)
...
- This repository (`hyperpolymath/Cliometrics.jl`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/Cliometrics.jl/security/advisories)
...
- [Security Advisories](https://github.com/hyperpolymath/Cliometrics.jl/security/advisories)
