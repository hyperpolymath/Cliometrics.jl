...
[arabic]
. Navigate to
https://github.com/hyperpolymath/Cliometrics.jl/security/advisories/new[Report
a Vulnerability]
...
https://github.com/hyperpolymath/Cliometrics.jl/security/advisories[Security
Advisories]
...
|*General questions*
|https://github.com/hyperpolymath/Cliometrics.jl/discussions[GitHub
Discussions]
...
_Thank you for helping keep Cliometrics.Jl and its users safe._ 🛡️
