...
doctor:
    @echo "Running diagnostics for Cliometrics.jl..."
...
help-me:
    @echo "=== Cliometrics.jl Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/hyperpolymath/Cliometrics.jl/issues/new"
    @echo ""
