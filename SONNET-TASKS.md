...
**Verification:**
```bash
cd /var$REPOS_DIR/Cliometrics.jl && grep -rn '{{PROJECT}}\|{{project}}\|hyperpolymath\|Cliometrics.jl\|github.com\|\[YOUR-REPO-NAME\]' . --include="*.idr" --include="*.zig" --include="*.md" --include="*.a2ml" --include="*.adoc" | grep -v ".git/" | grep -v "SONNET-TASKS"
# Should return zero lines
```
