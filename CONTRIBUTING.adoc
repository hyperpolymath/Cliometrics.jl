...
= Contributing — Cliometrics.jl
:toc: left

Contributions to `Cliometrics.jl` follow the Hyperpolymath estate conventions:
...
[source,bash]
----
git clone git@github.com:hyperpolymath/Cliometrics.jl.git
cd Cliometrics.jl
